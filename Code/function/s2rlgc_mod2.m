function output = s2rlgc_mod2(s_params,linelength,freq,z0,port_reorder)
...
%% Modify by Wei Guorui
% 1. disabled some warnnings
% 2. "Zbig" equals to "Z_params"!
% 3. notice the difference: S -> Td here & in function"s2abcd".£¿
...
if (m ~= freqpts)
    error(message('rf:s2rlgc:InvalidInputFreqLength',num2str(m),        ...
        num2str(freqpts)));
end
